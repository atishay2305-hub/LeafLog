      ...
      <section className="hero-area">
        <div className="hero-post-slides owl-carousel">
          <div className="single-hero-post bg-overlay">
            <div className="slide-img bg-img" style={{ backgroundImage: `url(${bg1.src})` }}></div>
          ...
          <div className="single-hero-post bg-overlay">
            <div className="slide-img bg-img" style={{ backgroundImage: `url(${bg2.src})` }}></div>
            <div className="container h-100">
              <div className="row h-100 align-items-center">
                <div className="col-12">
                  <div className="hero-slides-content text-center">
              ...
              <div className="alazea-service-area mb-100">
                <div className="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="100ms">
                  ...
                  <div className="service-content">
                    <h5>Plants Wiki</h5>
                    <p>Acess a comprehensive plant encyclopedia to learn more about your favorite plants. Expand your knowledge and discover new
                ...
                <div className="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="300ms">
                  ...
                  <div className="service-content">
                    <h5>Notification</h5>
                    <p>Recive timely Notifications to help you stay on top of your plant care routine. Get reminders for watering, fertilizing and other essential tasks.</p>
                  </div>
                </div>
                <div className="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="500ms">
                  ...
                  <div className="service-content">
                    <h5>Plant Logging</h5>
                    <p>keep a detailed log of your plant collection. Track watering schedules, soil changes and any special care your leafy friends need.</p>
                  </div>
                </div>
      ...
      <section className="about-us-area section-padding-100-0">
        <div className="container">
          <div className="row justify-content-between">
            ...
            <p>LeafLog: Your go-to web app for plant care. Access a vast plant encyclopedia, receive timely care reminders, and log your plant activities. Join a vibrant community of plant enthusiasts. Let's grow together!</p>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="section-heading text-center">
                <h2>OUR Gallery</h2>
                <p>We devote all of our experience and efforts for creation in Gallery</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-fluid">
          ...
          <div className="row alazea-portfolio">
            <div className="col-12 col-sm-6 col-lg-3 single_portfolio_item design home-design wow fadeInUp" data-wow-delay="100ms">
              <div className="portfolio-thumbnail bg-img" style={{ backgroundImage: `url(${bg16.src})` }}></div>
            ...
            <div className="col-12 col-sm-6 col-lg-3 single_portfolio_item garden wow fadeInUp" data-wow-delay="200ms">
              <div className="portfolio-thumbnail bg-img" style={{ backgroundImage: `url(${bg17.src})` }}></div>
              <div className="portfolio-hover-overlay">
            ...
            <div className="col-12 col-sm-6 col-lg-3 single_portfolio_item garden design wow fadeInUp" data-wow-delay="300ms">
              <div className="portfolio-thumbnail bg-img" style={{ backgroundImage: `url(${bg18.src})` }}></div>
              <div className="portfolio-hover-overlay">
            ...
            <div className="col-12 col-sm-6 col-lg-3 single_portfolio_item garden office-design wow fadeInUp" data-wow-delay="400ms">
              <div className="portfolio-thumbnail bg-img" style={{ backgroundImage: `url(${bg19.src})` }}></div>
              <div className="portfolio-hover-overlay">
            ...
            <div className="col-12 col-sm-6 col-lg-3 single_portfolio_item design office-design wow fadeInUp" data-wow-delay="100ms">
              <div className="portfolio-thumbnail bg-img" style={{ backgroundImage: `url(${bg20.src})` }}></div>
              <div className="portfolio-hover-overlay">
            ...
            <div className="col-12 col-sm-6 col-lg-3 single_portfolio_item garden wow fadeInUp" data-wow-delay="200ms">
              <div className="portfolio-thumbnail bg-img" style={{ backgroundImage: `url(${bg21.src})` }}></div>
              <div className="portfolio-hover-overlay">
            ...
            <div className="col-12 col-lg-6 single_portfolio_item home-design wow fadeInUp" data-wow-delay="300ms">
              <div className="portfolio-thumbnail bg-img" style={{ backgroundImage: `url(${bg22.src})` }}></div>
              <div className="portfolio-hover-overlay">
