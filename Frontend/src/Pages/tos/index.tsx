      ...
      <div className={styles.container}>
        ...
        <div className={styles.formWrapper}>
          <div className={styles.body}>
            <br />
            <br />
            LeafLog ("the Site") is committed to protecting the privacy of its
            ...
            <div className={styles.indent}>
              ...
              your name, email address, and location when you register an
              account with LeafLog or voluntarily provide such information.
              <br />
              Plant Data: LeafLog allows users to log information about their
              plants, including species, care routines, and growth progress.
              <br />
              Usage Data: We may collect non-personal information about how you
              interact with the Site, such as the features you use, the
              frequency of use, and device information.
            </div>
            Use of Information:
            <br />
            <div className={styles.indent}>
              Personal Information: We may use your personal information to
              provide you with the services offered by LeafLog, communicate with
              you, and improve the Site's functionality and user experience.
              <br />
              Plant Data: The plant data you log in LeafLog is used solely to
              provide you with plant care recommendations and track your plant's
              progress. This data is stored securely and is not shared with
              third parties unless you choose to do so.
              <br />
              Usage Data: We may use usage data to analyze trends, monitor the
              performance of the Site, and make improvements.
            </div>
            ...
            <div className={styles.indent}>
              ...
              required by law or as necessary to provide you with the services
              offered by LeafLog.
            </div>
            Data Security:
            <div className={styles.indent}>
              LeafLog takes reasonable measures to protect the security of your
              personal information and plant data. However, no method of
              transmission over the internet or electronic storage is 100%
              secure, and we cannot guarantee absolute security.
            </div>
            Children's Privacy:
            <div className={styles.indent}>
              LeafLog is not intended for use by children under the age of 13.
            ...
            <div className={styles.indent}>
              LeafLog reserves the right to modify or update this Privacy Policy
              at any time. We will notify users of any changes by posting the
              revised policy on our website or within the Site. Your continued
              use of LeafLog after the posting of changes constitutes acceptance
              of the revised policy.
            </div>
            Contact Us:
            <div className={styles.indent}>
              If you have any questions or concerns about this Privacy Policy or
              our data practices, please contact us at [Contact Information]. By
              using LeafLog, you consent to the collection, use, and disclosure
        ...
        <div className={styles.formWrapper}>
          <div className={styles.body}>
            ...
            <div className={styles.indent}>
              ...
              time without prior notice. Users are encouraged to review the
              terms periodically for changes. Continued use of the Site after
              the posting of modifications constitutes acceptance of the revised
              terms.
            </div>
            Termination:
            <div className={styles.indent}>
